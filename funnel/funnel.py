...
def create_figure(df):
    ...
    p.line("week", "app", source=source, color="green", legend_label="Applied")
    p.line("week", "acc", source=source, color="blue", legend_label="Accepted")
    p.line("week", "dep", source=source, color="red", legend_label="Deposited")
